 ...
 let res3 = window.document.getElementById("resultado");
  ...
  if(tabd.value.length === "" || Number(tabd.value <= 0 )){
    ...
    selec.innerHTML = ""
      ...
      if(selec2.options[selec2.selectedIndex].text === "Tabuada"){
   ...
   }else if(selec2.options[selec2.selectedIndex].text === "Multiplicação"){
   ...
   }else if(selec2.options[selec2.selectedIndex].text === "Subtração"){
   ...
   }else if (selec2.options[selec2.selectedIndex].text === "Soma"){
   ...
   }else if (selec2.options[selec2.selectedIndex].text === "Divisão"){
   ...
   }else if(selec2.options[selec2.selectedIndex].text === "Porcentagem"){
